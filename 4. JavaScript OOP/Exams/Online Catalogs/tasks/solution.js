function solve () {
    ...
    class Item { //id, description, name
        ...
        get description (){
            return this._description; //why here with _
        }
    ...
    class Book extends Item{ //description, name, isbn, genre
    ...
    class Media extends Item{ //description, name, duratiuon, rating
...
//  40/100 after Item, Book, Media and return
//  66/100 after Catalog
//  73/100 after BookCatalog
