function solve() {
    ...
    class Spell{ //name, manaCost, effect
        constructor(name, manaCost, effect) {
        this.name = name;
        this.manaCost = manaCost;
        this.effect = effect; //without _ because we have get an set
      }
    ...
    class ArmyUnit extends Unit{ //name, alignment, damage, health, count, speed, id
        constructor(name, alignment, damage, health, count, speed){
            super(name, alignment);
            this._id = getNextId(); //not from constructor by descrption
            this.damage = damage;
            this.health = health;
            this.count = count;
            this.speed = speed;
        ...
        set speed(x){
             VALIDATOR.isValidSpeed();
            this._speed = x;
        }
    }

    class Commander extends Unit{ //name, alignment, mana, spellbook, army
    ...
    const battlemanager = {
        ...
        findCommanders: function (query) { //name, alignment or name+alignment
            
            return battlemanagerData.commanders
                .slice()
                .filterByProperty(query, 'name') //only if it has name property
        ...
        findArmyUnits: function (query) { //id, name, alignment
