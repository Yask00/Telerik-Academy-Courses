...
public class MatrixMultiplication
{
    static void Main()
    {
        ...
        int firstMatrixRowsCount = firstMatrix.GetLength(0);  // 4
        int firstMatrixColumnsCount = firstMatrix.GetLength(1); // 2
        int secondMatrixRowsCount = secondMatrix.GetLength(0); // 2 
        int secondMatrixColumnsCount = secondMatrix.GetLength(1); // 3
        ...
        int[,] resultMatrix = new int[firstMatrixRowsCount, secondMatrixColumnsCount]; // 4 3
